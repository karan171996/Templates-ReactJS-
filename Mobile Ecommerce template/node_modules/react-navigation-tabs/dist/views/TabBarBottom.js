    ...
    return <SafeAreaView style={tabBarStyle} forceInset={{ bottom: 'always', top: 'never' }}>
        ...
        return <TouchableWithoutFeedback key={route.key} onPress={() => {
          ...
          onTabPress({ route });
              ...
              <View style={[styles.tab, { backgroundColor }, this._shouldUseHorizontalLabels() ? styles.tabLandscape : styles.tabPortrait, styles.tabPortrait, tabStyle]}>
